...
const result = await client.classify({
  ...
  speed: "fast",                              // optional: "fast" (default) or "standard"
  cache: true,                                // optional: set false to bypass cache
  sourceType: "support ticket",               // optional: context for prompt tuning
  examples: {                                 // optional: per-label examples
    billing: ["I need a refund", "Update my card"],
    technical: ["Can't log in", "App crashed"],
  },
});
...
const result = await client.tag({
  ...
  speed: "fast",                               // optional: "fast" (default) or "standard"
  cache: true,                                 // optional: set false to bypass cache
  sourceType: "news article",                  // optional: context for prompt tuning
  examples: {                                  // optional: per-label examples
    technology: ["New chip released", "Software update"],
  },
});
