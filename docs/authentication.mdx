...
- 30 requests/min, 150K tokens/min, 2 concurrent
- 5-minute cache TTL
- Responses include `"public": true`

For higher limits and longer cache TTL, sign up for a free API key.

## API Keys

For higher rate limits and full access, authenticate with a Bearer token.
