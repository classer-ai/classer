...
### Generative LLM (OpenAI-compatible)

| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | [`/v1/chat/completions`](/api-reference/generate#chat-completions) | OpenAI Chat Completions API |
| POST | [`/v1/responses`](/api-reference/generate#responses) | OpenAI Responses API |
| GET  | [`/v1/models`](/api-reference/generate#list-models) | List available generative models |
...
See [Pricing & Limits](/pricing) for full details on priority levels, rate limits, free tier, and validation limits.
